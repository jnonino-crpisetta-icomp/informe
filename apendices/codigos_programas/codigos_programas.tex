...
%																					%
%	Parte: Apendices																%
%	Capitulo: Códigos en C de los programas ejecutados								%
...
\chapter{Códigos en C de los programas ejecutados}
	\label{ap:codigos_programas}

	A continuación, se muestran los códigos en C de los programas ejecutados en las pruebas realizadas.
	...
	% Programa del Escritor Escritor con cinco hilos usando Semáforos	
		\section{Escritor/Escritor (5 hilos) usando Semáforos}
			\label{sec:programa_escritor_sem}	
			\lstinputlisting{./apendices/codigos_programas/escritores_sem.c}	

	% Programa de la fábrica de mesas usando Redes de Petri
		\section{Fábrica de mesas usando Redes de Petri}
			\label{sec:programa_fabrica_mesas_petri}
			\lstinputlisting{./apendices/codigos_programas/fabrica_mesas_petri.c}			

	% Programa de la fábrica de mesas usando Semáforos
		\section{Fábrica de mesas usando Semáforos}
	...
	% Programa de la cena de los filosofos usando Redes de Petri
		\section{Cena de los filósofos usando Redes de Petri SIN interrupciones}
			\label{sec:programa_cena_filosofos_petri}
			\lstinputlisting{./apendices/codigos_programas/cena_filosofos_petri.c}			

	% Programa de la cena de los filosofos usando Semáforos
		\section{Cena de los filósofos usando Redes de Petri CON interrupciones}
