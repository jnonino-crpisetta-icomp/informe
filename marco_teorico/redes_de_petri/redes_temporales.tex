...
\section{Redes de Petri Temporales}
	...
	\begin{itemize}
		...
		\item El parámetro temporal puede determinar también el tiempo que debe transcurrir entre la retirada 
			...
			lugares de salida; en éste caso se habla de tiempo de \textbf{\emph{disparo (firing time)}}.
	...
	\subsection{Redes de Petri con Tiempo}
		...
		En ésta sección se describirán las \textbf{\emph{Redes de Petri con Tiempo}} como la red \emph{C} 
			...
			\begin{itemize}
				\item \emph{Intervalo puntual}
					\begin{equation*}
						[\alpha,\alpha]
					\end{equation*}
					En este caso, el tiempo de sensibilización es fijo, luego de que transcurra el tiempo $\alpha$ la 
		...
		\subsubsection{Regla de disparo de transiciones}
			...
			El intervalo de tiempos de disparo válidos para $ti$ será, por tanto $[w_i + min_i, w_i + max_i]$.
		...
		\subsubsection{Estados en una Red de Petri con Tiempo}
			...
			\begin{itemize}
				...
				\item $Intervalo'(k) = Intervalo(k) + 1$ si $k\neq t$, en el marcado $m$ esta sensibilizada 
					y sigue estandolo en el marcado $m'$. 
	...
	\subsection{Redes de Petri Temporizadas}
		...
		En ésta sección se describirán las \textbf{\emph{Redes de Petri Temporizadas}} como la red \emph{B} 
		de la Figura \ref{fig:Petri16}).
		...
		\subsubsection{Regla de disparos y estados en una Red de Petri Temporizada} 
			...
			\begin{enumerate}
				...
				\item Se espera el tiempo indicado por el valor de duración de la transición. Con la transición 
					marcada como no sensibilizada, se espera hasta que la cuenta de tiempo, que comenzó al 
